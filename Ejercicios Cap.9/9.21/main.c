...
/* Examen de admisi�n.
El programa, al recibir como dato un archivo de acceso directo que contiene informaci�n sobre los alumnos que presentaron el examen de admisi�n a una universidad, genera informaci�n importante para el Departamento de Control Escolar. */
...
/* Esta funci�n genera un archivo de los alumnos admitidos en cada una de las carreras de la universidad. */
{
    alumno alu;
    rewind(ap);
    fread(&alu, sizeof(alumno), 1, ap);
...
/* Esta funci�n se utiliza para obtener el promedio que consiguieron los alumnos admitidos en cada una de las carreras. */
{
    alumno alu;
    float cal[5], sum;
    int i, j;
    i = 0;
    sum = 0;
    rewind(c1); /* Es importante posicionarse al inicio del archivo, pues de lo contrario se generar�a un error al ejecutar el programa. */
